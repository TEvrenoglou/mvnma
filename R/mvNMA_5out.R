...
model{
  ...
  s[i,1,5] <- control15[i]*rho15*sqrt(var1[i]+psi1.sq)*sqrt(var5[i]+psi5.sq)
  ...
  s[i,2,5] <- control25[i]*rho25*sqrt(var2[i]+psi2.sq)*sqrt(var5[i]+psi5.sq)
  ...
  s[i,3,5] <- control35[i]*rho35*sqrt(var3[i]+psi3.sq)*sqrt(var5[i]+psi5.sq)
  
  s[i,5,3] <- s[i,3,5]
  
  
  s[i,4,5] <- control45[i]*rho45*sqrt(var4[i]+psi4.sq)*sqrt(var5[i]+psi5.sq)
...
### off-diagonal elements
    ...
    S[i,1,5] <- control15[i]*rho15*sqrt(S[i,1,1])*sqrt(S[i,5,5])
    ...
    S[i,1,7] <- control12[i]*rho12*sqrt(S[i,1,1])*sqrt(S[i,7,7])/2
    
    S[i,7,1] <- S[i,1,7]
    
    S[i,1,8]<- control13[i]*rho13*sqrt(S[i,1,1])*sqrt(S[i,8,8])/2
    
    S[i,8,1] <- S[i,1,8]
    
    S[i,1,9] <- control14[i]*rho14*sqrt(S[i,1,1])*sqrt(S[i,9,9])/2
    
    S[i,9,1] <- S[i,1,9]
    
    S[i,1,10] <- control15[i]*rho15*sqrt(S[i,1,1])*sqrt(S[i,10,10])/2
    ...
    S[i,2,5] <- control25[i]*rho25*sqrt(S[i,2,2])*sqrt(S[i,5,5])

    S[i,5,2] <- S[i,2,5]
    
    S[i,2,6] <- control12[i]*rho12*sqrt(S[i,2,2])*sqrt(S[i,6,6])/2
    ...
    S[i,2,8] <- control23[i]*rho23*sqrt(S[i,2,2])*sqrt(S[i,8,8])/2

    S[i,8,2] <- S[i,2,8]
    
    S[i,2,9] <- control24[i]*rho24*sqrt(S[i,2,2])*sqrt(S[i,9,9])/2

    S[i,9,2] <- S[i,2,9]
    
    S[i,2,10] <- control25[i]*rho25*sqrt(S[i,2,2])*sqrt(S[i,10,10])/2
    ...
    S[i,3,5] <- control35[i]*rho35*sqrt(S[i,3,3])*sqrt(S[i,5,5])
    
    S[i,5,3] <- S[i,3,5]
    
    S[i,3,6] <- control13[i]*rho13*sqrt(S[i,3,3])*sqrt(S[i,6,6])/2
    
    S[i,6,3] <- S[i,3,6]
    
    S[i,3,7] <- control23[i]*rho23*sqrt(S[i,3,3])*sqrt(S[i,7,7])/2
    ...
    S[i,3,9] <- control34[i]*rho34*sqrt(S[i,3,3])*sqrt(S[i,9,9])/2
    
    S[i,9,3] <- S[i,3,9]
    
    S[i,3,10] <- control35[i]*rho35*sqrt(S[i,3,3])*sqrt(S[i,10,10])/2
    
    S[i,10,3] <- S[i,3,10]
    
   
    
    S[i,4,5] <- control45[i]*rho45*sqrt(S[i,4,4])*sqrt(S[i,5,5])
    
    S[i,5,4] <- S[i,4,5]
    
    S[i,4,6] <- control14[i]*rho14*sqrt(S[i,4,4])*sqrt(S[i,6,6])/2
    
    S[i,6,4] <- S[i,4,6]
    
    S[i,4,7] <- control24[i]*rho24*sqrt(S[i,4,4])*sqrt(S[i,7,7])/2
    
    S[i,7,4] <- S[i,4,7]
    
    S[i,4,8] <- control34[i]*rho34*sqrt(S[i,4,4])*sqrt(S[i,8,8])/2
    ...
    S[i,4,10] <- control45[i]*rho45*sqrt(S[i,4,4])*sqrt(S[i,10,10])/2
    
    S[i,10,4] <- S[i,4,10]
    

    S[i,5,6] <- control15[i]*rho15*sqrt(S[i,5,5])*sqrt(S[i,6,6])/2
    
    S[i,6,5] <- S[i,5,6]
    
    S[i,5,7] <- control25[i]*rho25*sqrt(S[i,5,5])*sqrt(S[i,7,7])/2
    
    S[i,7,5] <- S[i,5,7]
    
    S[i,5,8] <- control35[i]*rho35*sqrt(S[i,5,5])*sqrt(S[i,8,8])/2
    
    S[i,8,5] <- S[i,5,8]
    
    S[i,5,9] <- control45[i]*rho45*sqrt(S[i,5,5])*sqrt(S[i,9,9])/2
    ...
    S[i,6,7] <- control12[i]*rho12*sqrt(S[i,6,6])*sqrt(S[i,7,7])
    
    S[i,7,6] <- S[i,6,7]
    
    S[i,6,8] <- control13[i]*rho13*sqrt(S[i,6,6])*sqrt(S[i,8,8])
    
    S[i,8,6] <- S[i,6,8]
    
    S[i,6,9] <- control14[i]*rho14*sqrt(S[i,6,6])*sqrt(S[i,9,9])
    
    S[i,9,6] <- S[i,6,9]
    
    S[i,6,10] <- control15[i]*rho15*sqrt(S[i,6,6])*sqrt(S[i,10,10])
    
    S[i,10,6] <- S[i,6,10]
    
     
    S[i,7,8] <- control23[i]*rho23*sqrt(S[i,7,7])*sqrt(S[i,8,8])
    
    S[i,8,7] <- S[i,7,8]
    
    S[i,7,9] <- control24[i]*rho24*sqrt(S[i,7,7])*sqrt(S[i,9,9])
    
    S[i,9,7] <- S[i,7,9]
    
    S[i,7,10] <- control25[i]*rho25*sqrt(S[i,7,7])*sqrt(S[i,10,10])
    
    S[i,10,7] <- S[i,7,10]
    
    
    S[i,8,9] <- control34[i]*rho34*sqrt(S[i,8,8])*sqrt(S[i,9,9])
    
    S[i,9,8] <- S[i,8,9]
    
    S[i,8,10] <- control35[i]*rho35*sqrt(S[i,8,8])*sqrt(S[i,10,10])
    
    S[i,10,8] <- S[i,8,10]
    
    
    S[i,9,10] <- control45[i]*rho45*sqrt(S[i,9,9])*sqrt(S[i,10,10])
  ...
  rho12 ~ dunif(lb.rho1,ub.rho1)

  rho13 ~ dunif(lb.rho2,ub.rho2)
  
  rho14 ~ dunif(lb.rho3,ub.rho3)
  
  rho15 ~ dunif(lb.rho4,ub.rho4)

  rho23 ~ dunif(lb.rho5,ub.rho5)
  
  rho24 ~ dunif(lb.rho6,ub.rho6)
  
  rho25 ~ dunif(lb.rho7,ub.rho7)
  
  rho34 ~ dunif(lb.rho8,ub.rho8)
  
  rho35 ~ dunif(lb.rho9,ub.rho9)
  
  rho45 ~ dunif(lb.rho10,ub.rho10)
